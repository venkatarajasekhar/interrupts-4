...
__VERIFIER_atomic_TRANS_enter_thread(0);
...
__VERIFIER_atomic_TRANS_leave_thread(0);
}
...
__VERIFIER_atomic_TRANS_enter_thread(1);
...
__VERIFIER_atomic_TRANS_leave_thread(1);
}
