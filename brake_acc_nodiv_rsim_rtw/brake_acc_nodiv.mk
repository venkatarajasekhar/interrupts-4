...
#
# File    : rsim_unix.tmf   $Revision: 1.41.4.41 $
#
# Abstract:
...
MAKECMD         = /usr/local/Matlab-R2011b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = brake_acc_nodiv
MODULES                = brake_acc_nodiv_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_look.c rt_look1d.c rt_nonfinite.c 
MAKEFILE               = brake_acc_nodiv.mk
MATLAB_ROOT            = /usr/local/Matlab-R2011b
ALT_MATLAB_ROOT        = /usr/local/Matlab-R2011b
MATLAB_ROOTQ           = \"/usr/local/Matlab-R2011b\"	
MASTER_ANCHOR_DIR      = 
START_DIR              = /auto/users/schram/Documents/peter/work/examples/Brake_No_Div
S_FUNCTIONS            = 
S_FUNCTIONS_LIB        = 
COMPUTER               = GLNXA64
BUILDARGS              =  GENERATE_REPORT=0 PCMATLABROOT="/usr/local/Matlab-R2011b"
...
ADD_INCLUDES = \
	-I$(START_DIR)/brake_acc_nodiv_rsim_rtw \
	-I$(START_DIR) \
...
ifneq (,$(findstring GLNX,$(COMPUTER)))
  ...
  MATLIBS += -Wl,-lmat,-lmx,-lut,-lmwsl_fileio
 endif
...
ifneq (,$(findstring SOL,$(COMPUTER)))
  ...
  MATLIBS += -lmat -lmx -lut -lmwsl_fileio
endif
...
ifneq (,$(findstring MAC,$(COMPUTER)))
 ...
 MATLIBS = -L$(BINDIR) -L$(MATLAB_ROOT)/sys/os/$(ARCH)
  ...
  MATLIBS += -lmat -lmx -lut -ldl -lmwsl_fileio
endif
...
$(PRODUCT) : $(OBJS)  $(SHARED_LIB) $(LIBS)  $(MODELREF_LINK_LIBS)
	$(BIN_SETTING) $(LINK_OBJS) $(MODELREF_LINK_LIBS) $(SHARED_LIB) $(LIBS) $(MATLIBS) 
