...
#
# File    : grt_unix.tmf   $Revision: 1.81.4.39 $
#
# Abstract:
...
MATLAB_BIN           = /usr/local/Matlab-R2011b/bin
MASTER_ANCHOR_DIR    = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/brake_acc_nodiv_grt_rtw \
	-I$(START_DIR) \
...
ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ...
    SRCS               += $(MODEL).$(TARGET_LANG_EXT) grt_main.c rt_sim.c $(EXT_SRC) $(SOLVER)
else
